...
export function structuralSceneSignature(composition){
 ...
 return digest({movement:r.movement,graph:{nodes:nodes.map(({capability,settings})=>({capability,settings})),wires},solids,camera:composition.presentation?.camera});
}
