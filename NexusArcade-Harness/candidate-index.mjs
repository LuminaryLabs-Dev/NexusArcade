...
export async function buildCandidateIndex(ids){
 ...
 return {version:6,goalId:'G02',status:'NEEDS_REVIEW',purpose:'Current-source contrasting foundation candidates; provisional until independent review.',sourceHashes,sourceConsistent:sourceHashes.length===1,candidates,distinctSignatures:signatures.size===candidates.length,contrast:{families:[...kinds],views:[...views]},requiredReview:['independent concept contribution','comparative novelty rubric','presentation and audio','target-device performance','human comprehension'],created:Date.now()};
}
