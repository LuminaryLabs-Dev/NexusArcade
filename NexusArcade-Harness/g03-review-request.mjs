...
export async function writeG03ReviewRequest(){
 ...
 const availableEvidence=(manifest.independentSuites??[]).filter(s=>s.evidenceRef).map(s=>({name:s.name,status:s.status,path:s.evidenceRef.path,independent:s.evidenceRef.independent===true}));
