# G18 — Concept and genre interpretation: Review

## Summary
Make independent concepts shape coherent rules across genre contexts.

## Outcome
Independent B05 verdict and regression findings for affected earlier batches.

## Changes
- Required work: Compare intent to play traces; remove labels; reject superficial themes, forced genre templates and unsupported promises.
- Entry: G17 completed with current evidence. Follow [shared rules](../RULES.md); queue fields are indexed in ../goal-queue.json.
...
Execution authority: [goal-queue.json](../goal-queue.json) entry G18 and [execution-contract.json](../execution-contract.json).
