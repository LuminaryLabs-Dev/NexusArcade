# G20 — Visual identity: Build

## Summary
Establish distinct coherent silhouettes, spaces, materials and lighting.

## Outcome
100 new provisionally accepted slots in B06, plus all failed-attempt accounting and evidence for the next reviewer.

## Changes
- Required work: Implement shared presentation capabilities and generate profiles with differentiated visual organization.
- Entry: G19 completed with current evidence. Follow [shared rules](../RULES.md); queue fields are indexed in ../goal-queue.json.
...
Execution authority: [goal-queue.json](../goal-queue.json) entry G20 and [execution-contract.json](../execution-contract.json).
...
## Review and Gates
- Specific gate: Palette changes alone fail novelty; a numeric image distance alone cannot establish distinct experience.
