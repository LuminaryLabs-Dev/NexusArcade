# G15 — Connected systems: Review

## Summary
Make domain-to-domain relationships drive the experience.

## Outcome
Independent B04 verdict and regression findings for affected earlier batches.

## Changes
- Required work: Test feedback loops, resource exhaustion, deadlocks, race/order effects and removal of a claimed essential domain.
- Entry: G14 completed with current evidence. Follow [shared rules](../RULES.md); queue fields are indexed in ../goal-queue.json.
...
Execution authority: [goal-queue.json](../goal-queue.json) entry G15 and [execution-contract.json](../execution-contract.json).
