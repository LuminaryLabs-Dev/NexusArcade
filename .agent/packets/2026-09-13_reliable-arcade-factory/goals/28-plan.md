...
## Changes
- Required work: Use the collection index to identify gaps; define compatibility and regression scopes for high-interaction combinations.
- Entry: G27 completed with current evidence. Follow [shared rules](../RULES.md); queue fields are indexed in ../goal-queue.json.
...
Execution authority: [goal-queue.json](../goal-queue.json) entry G28 and [execution-contract.json](../execution-contract.json).
