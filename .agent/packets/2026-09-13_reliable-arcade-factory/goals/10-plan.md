...
## Changes
- Required work: Define each action precondition, state transition, interrupt behavior, feedback and dependency contract.
- Entry: G09 completed with current evidence. Follow [shared rules](../RULES.md); queue fields are indexed in ../goal-queue.json.
...
Execution authority: [goal-queue.json](../goal-queue.json) entry G10 and [execution-contract.json](../execution-contract.json).
