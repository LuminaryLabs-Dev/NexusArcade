...
## Changes
- Required work: Specify reusable form/material/light choices, asset provenance, visual rubrics and matched capture conditions; calibrate similarity on known duplicates and distinct examples.
- Entry: G18 completed with current evidence. Follow [shared rules](../RULES.md); queue fields are indexed in ../goal-queue.json.
...
Execution authority: [goal-queue.json](../goal-queue.json) entry G19 and [execution-contract.json](../execution-contract.json).
